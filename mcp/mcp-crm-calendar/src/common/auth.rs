//! Identidad del llamante extraída del JWT.
//!
//! El sidecar Envoy ya validó la firma del token contra Keycloak antes de que
//! la petición llegue aquí. Este módulo NO valida firma: solo decodifica en
//! base64 el payload para extraer `preferred_username` y `realm_access.roles`.
